...
**AlignConsecutiveBitFields** (`AlignConsecutiveStyle`) clang-format 11 [¶](https://clang.llvm.org/docs/#alignconsecutivebitfields)
...
**AlignConsecutiveMacros** (`AlignConsecutiveStyle`) clang-format 9 [¶](https://clang.llvm.org/docs/#alignconsecutivemacros)
...
**AlignConsecutiveTableGenDefinitionColons** (`AlignConsecutiveStyle`) clang-format 19 [¶](https://clang.llvm.org/docs/#alignconsecutivetablegendefinitioncolons)
...
**AlwaysBreakTemplateDeclarations** (`deprecated`) clang-format 3.4 [¶](https://clang.llvm.org/docs/#alwaysbreaktemplatedeclarations)
...
**BreakAfterAttributes** (`AttributeBreakingStyle`) clang-format 16 [¶](https://clang.llvm.org/docs/#breakafterattributes)
...
**BreakBeforeConceptDeclarations** (`BreakBeforeConceptDeclarationsStyle`) clang-format 12 [¶](https://clang.llvm.org/docs/#breakbeforeconceptdeclarations)
...
**BreakBinaryOperations** (`BreakBinaryOperationsStyle`) clang-format 20 [¶](https://clang.llvm.org/docs/#breakbinaryoperations)
...
**BreakStringLiterals** (`Boolean`) clang-format 3.9 [¶](https://clang.llvm.org/docs/#breakstringliterals)
...
**DisableFormat** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#disableformat)
...
**ExperimentalAutoDetectBinPacking** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#experimentalautodetectbinpacking)
...
**IncludeIsMainRegex** (`String`) clang-format 3.9 [¶](https://clang.llvm.org/docs/#includeismainregex)
...
**JavaScriptQuotes** (`JavaScriptQuoteStyle`) clang-format 3.9 [¶](https://clang.llvm.org/docs/#javascriptquotes)
...
**Language** (`LanguageKind`) clang-format 3.5 [¶](https://clang.llvm.org/docs/#language)
...
**MacroBlockEnd** (`String`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#macroblockend)
...
**NamespaceIndentation** (`NamespaceIndentationKind`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#namespaceindentation)
...
**ObjCPropertyAttributeOrder** (`List of Strings`) clang-format 18 [¶](https://clang.llvm.org/docs/#objcpropertyattributeorder)
...
**ObjCSpaceBeforeProtocolList** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#objcspacebeforeprotocollist)

Add a space in front of an Objective-C protocol list, i.e. use `Foo <Protocol>` instead of `Foo<Protocol>`.

**PPIndentWidth** (`Integer`) clang-format 13 [¶](https://clang.llvm.org/docs/#ppindentwidth)
...
**PackConstructorInitializers** (`PackConstructorInitializersStyle`) clang-format 14 [¶](https://clang.llvm.org/docs/#packconstructorinitializers)
...
**PenaltyBreakAssignment** (`Unsigned`) clang-format 5 [¶](https://clang.llvm.org/docs/#penaltybreakassignment)

The penalty for breaking around an assignment operator.

**PenaltyBreakBeforeFirstCallParameter** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#penaltybreakbeforefirstcallparameter)

The penalty for breaking a function call after `call(`.

**PenaltyBreakFirstLessLess** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#penaltybreakfirstlessless)

The penalty for breaking before the first `<<`.

**PenaltyBreakOpenParenthesis** (`Unsigned`) clang-format 14 [¶](https://clang.llvm.org/docs/#penaltybreakopenparenthesis)

The penalty for breaking after `(`.

**PenaltyBreakScopeResolution** (`Unsigned`) clang-format 18 [¶](https://clang.llvm.org/docs/#penaltybreakscoperesolution)

The penalty for breaking after `::`.

**PenaltyBreakString** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#penaltybreakstring)

The penalty for each line break introduced inside a string literal.

**PenaltyBreakTemplateDeclaration** (`Unsigned`) clang-format 7 [¶](https://clang.llvm.org/docs/#penaltybreaktemplatedeclaration)

The penalty for breaking after template declaration.

**PenaltyExcessCharacter** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#penaltyexcesscharacter)

The penalty for each character outside of the column limit.

**PenaltyIndentedWhitespace** (`Unsigned`) clang-format 12 [¶](https://clang.llvm.org/docs/#penaltyindentedwhitespace)

Penalty for each character of whitespace indentation (counted relative to leading non-whitespace column).

**PenaltyReturnTypeOnItsOwnLine** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#penaltyreturntypeonitsownline)

Penalty for putting the return type of a function onto its own line.

**PointerAlignment** (`PointerAlignmentStyle`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#pointeralignment)
...
**QualifierAlignment** (`QualifierAlignmentStyle`) clang-format 14 [¶](https://clang.llvm.org/docs/#qualifieralignment)
...
**QualifierOrder** (`List of Strings`) clang-format 14 [¶](https://clang.llvm.org/docs/#qualifierorder)
...
**RawStringFormats** (`List of RawStringFormats`) clang-format 6 [¶](https://clang.llvm.org/docs/#rawstringformats)
...
**ReferenceAlignment** (`ReferenceAlignmentStyle`) clang-format 13 [¶](https://clang.llvm.org/docs/#referencealignment)
...
**RemoveBracesLLVM** (`Boolean`) clang-format 14 [¶](https://clang.llvm.org/docs/#removebracesllvm)
...
**RemoveEmptyLinesInUnwrappedLines** (`Boolean`) clang-format 20 [¶](https://clang.llvm.org/docs/#removeemptylinesinunwrappedlines)
...
**RemoveParentheses** (`RemoveParenthesesStyle`) clang-format 17 [¶](https://clang.llvm.org/docs/#removeparentheses)
...
**RemoveSemicolon** (`Boolean`) clang-format 16 [¶](https://clang.llvm.org/docs/#removesemicolon)
...
**RequiresClausePosition** (`RequiresClausePositionStyle`) clang-format 15 [¶](https://clang.llvm.org/docs/#requiresclauseposition)
...
**RequiresExpressionIndentation** (`RequiresExpressionIndentationKind`) clang-format 16 [¶](https://clang.llvm.org/docs/#requiresexpressionindentation)
...
**SeparateDefinitionBlocks** (`SeparateDefinitionStyle`) clang-format 14 [¶](https://clang.llvm.org/docs/#separatedefinitionblocks)
...
**ShortNamespaceLines** (`Unsigned`) clang-format 13 [¶](https://clang.llvm.org/docs/#shortnamespacelines)
...
**SkipMacroDefinitionBody** (`Boolean`) clang-format 18 [¶](https://clang.llvm.org/docs/#skipmacrodefinitionbody)

Do not format macro definition body.

**SortIncludes** (`SortIncludesOptions`) clang-format 3.8 [¶](https://clang.llvm.org/docs/#sortincludes)
...
**SortJavaStaticImport** (`SortJavaStaticImportOptions`) clang-format 12 [¶](https://clang.llvm.org/docs/#sortjavastaticimport)
...
**SortUsingDeclarations** (`SortUsingDeclarationsOptions`) clang-format 5 [¶](https://clang.llvm.org/docs/#sortusingdeclarations)
...
**SpaceAfterCStyleCast** (`Boolean`) clang-format 3.5 [¶](https://clang.llvm.org/docs/#spaceaftercstylecast)
...
**SpaceAfterLogicalNot** (`Boolean`) clang-format 9 [¶](https://clang.llvm.org/docs/#spaceafterlogicalnot)
...
**SpaceAfterTemplateKeyword** (`Boolean`) clang-format 4 [¶](https://clang.llvm.org/docs/#spaceaftertemplatekeyword)
...
**SpaceAroundPointerQualifiers** (`SpaceAroundPointerQualifiersStyle`) clang-format 12 [¶](https://clang.llvm.org/docs/#spacearoundpointerqualifiers)
...
**SpaceBeforeAssignmentOperators** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spacebeforeassignmentoperators)
...
**SpaceBeforeCaseColon** (`Boolean`) clang-format 12 [¶](https://clang.llvm.org/docs/#spacebeforecasecolon)
...
**SpaceBeforeCpp11BracedList** (`Boolean`) clang-format 7 [¶](https://clang.llvm.org/docs/#spacebeforecpp11bracedlist)
...
**SpaceBeforeCtorInitializerColon** (`Boolean`) clang-format 7 [¶](https://clang.llvm.org/docs/#spacebeforectorinitializercolon)
...
**SpaceBeforeInheritanceColon** (`Boolean`) clang-format 7 [¶](https://clang.llvm.org/docs/#spacebeforeinheritancecolon)
...
**SpaceBeforeJsonColon** (`Boolean`) clang-format 17 [¶](https://clang.llvm.org/docs/#spacebeforejsoncolon)
...
**SpaceBeforeParens** (`SpaceBeforeParensStyle`) clang-format 3.5 [¶](https://clang.llvm.org/docs/#spacebeforeparens)
...
**SpaceBeforeParensOptions** (`SpaceBeforeParensCustom`) clang-format 14 [¶](https://clang.llvm.org/docs/#spacebeforeparensoptions)
...
**SpaceBeforeRangeBasedForLoopColon** (`Boolean`) clang-format 7 [¶](https://clang.llvm.org/docs/#spacebeforerangebasedforloopcolon)
...
**SpaceBeforeSquareBrackets** (`Boolean`) clang-format 10 [¶](https://clang.llvm.org/docs/#spacebeforesquarebrackets)
...
**SpaceInEmptyBlock** (`Boolean`) clang-format 10 [¶](https://clang.llvm.org/docs/#spaceinemptyblock)
...
**SpaceInEmptyParentheses** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spaceinemptyparentheses)

If `true`, spaces may be inserted into `()`. This option is **deprecated**. See `InEmptyParentheses` of `SpacesInParensOptions`.

**SpacesInAngles** (`SpacesInAnglesStyle`) clang-format 3.4 [¶](https://clang.llvm.org/docs/#spacesinangles)
...
**SpacesInCStyleCastParentheses** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spacesincstylecastparentheses)

If `true`, spaces may be inserted into C style casts. This option is **deprecated**. See `InCStyleCasts` of `SpacesInParensOptions`.

**SpacesInConditionalStatement** (`Boolean`) clang-format 10 [¶](https://clang.llvm.org/docs/#spacesinconditionalstatement)
...
**SpacesInContainerLiterals** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spacesincontainerliterals)
...
**SpacesInParens** (`SpacesInParensStyle`) clang-format 17 [¶](https://clang.llvm.org/docs/#spacesinparens)
...
**SpacesInParensOptions** (`SpacesInParensCustom`) clang-format 17 [¶](https://clang.llvm.org/docs/#spacesinparensoptions)
...
**SpacesInParentheses** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spacesinparentheses)
...
**SpacesInSquareBrackets** (`Boolean`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#spacesinsquarebrackets)
...
**Standard** (`LanguageStandard`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#standard)
...
**StatementAttributeLikeMacros** (`List of Strings`) clang-format 12 [¶](https://clang.llvm.org/docs/#statementattributelikemacros)
...
**StatementMacros** (`List of Strings`) clang-format 8 [¶](https://clang.llvm.org/docs/#statementmacros)
...
**TabWidth** (`Unsigned`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#tabwidth)

The number of columns used for tab stops.

**TableGenBreakInsideDAGArg** (`DAGArgStyle`) clang-format 19 [¶](https://clang.llvm.org/docs/#tablegenbreakinsidedagarg)
...
**TableGenBreakingDAGArgOperators** (`List of Strings`) clang-format 19 [¶](https://clang.llvm.org/docs/#tablegenbreakingdagargoperators)
...
**TemplateNames** (`List of Strings`) clang-format 20 [¶](https://clang.llvm.org/docs/#templatenames)

A vector of non-keyword identifiers that should be interpreted as template names.

A `<` after a template name is annotated as a template opener instead of a binary operator.

**TypeNames** (`List of Strings`) clang-format 17 [¶](https://clang.llvm.org/docs/#typenames)
...
**TypenameMacros** (`List of Strings`) clang-format 9 [¶](https://clang.llvm.org/docs/#typenamemacros)
...
**UseCRLF** (`Boolean`) clang-format 10 [¶](https://clang.llvm.org/docs/#usecrlf)

This option is **deprecated**. See `LF` and `CRLF` of `LineEnding`.

**UseTab** (`UseTabStyle`) clang-format 3.7 [¶](https://clang.llvm.org/docs/#usetab)
...
**VerilogBreakBetweenInstancePorts** (`Boolean`) clang-format 17 [¶](https://clang.llvm.org/docs/#verilogbreakbetweeninstanceports)
...
**WhitespaceSensitiveMacros** (`List of Strings`) clang-format 11 [¶](https://clang.llvm.org/docs/#whitespacesensitivemacros)
