...
source: "https://habr.com/ru/articles/324382/"
author:
  - "[[Богданов Илья]]"
published: 2017-03-20
created: 2025-06-18
description: "Перевод статьи Andrew Hobden \"Pretty State Machine Patterns in Rust\". Ссылка на оригинал в конце. Последнее время я много размышлял о шаблонах проектирования и приемах, которые мы используем..."
tags:
  - "clippings"
---
...
На протяжении всей статьи вы можете запускать все примеры на [Rust Playground](https://play.rust-lang.org/), я обычно использую Nightly версию по привычке.
...
Если вы следили за записями в моем блоге в последнее время, вы, возможно, знаете, что я предпочитаю писать о Raft. Именно Raft, а также общение с [@argorak](https://twitter.com/Argorak) подтолкнули меня к проведению этого исследования.
...
[Ссылка на оригинал](https://hoverbear.org/2016/10/12/rust-state-machine-pattern/)
...
[Rust разработчик](https://career.habr.com/vacancies/rust_developer)
